...
public class DozerConverterTest {
	...
	public void testPersonToVO() {
		...
		PersonVO vo = DozerParser.parseObject(p, PersonVO.class);
	...
	public void testVOToPerson() {
		...
		Person p = DozerParser.parseObject(vo, Person.class);
	...
	public void testPersonsTOVOList() {
		...
		List<PersonVO> vos = DozerParser.parseListObjects(persons, PersonVO.class);
	...
	public void testVOsToPersonList() {
		...
		List<Person> persons = DozerParser.parseListObjects(vos, Person.class);
